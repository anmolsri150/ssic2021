...
<!--            <div class="text">Sorry, we couldn't find the page you're looking for</div>-->
            ...
            <ol >
                <li><p>1). &nbsp Smart  Healthcare</p>
    
                </li>
                <li><p>2). &nbsp Smart Risk Forecasting </p>
        
                </li>
            
    
            <li><p>3). &nbsp Smart Emergency Management </p>
        
                </li>
            
    
            <li><p>4). &nbsp Smart Resource Allocation</p>
            ...
            <li><p>6). &nbsp Internet of Medical Things (IoMT)</p>
        
                </li>
            <li><p>7). &nbsp Smart Broadcast Management for Pandemic Monitoring</p>
        
                </li>
            <li><p>8). &nbsp Community Impact</p>
        
                </li>
           <li><p>9). &nbsp Smart Network collaboration </p>

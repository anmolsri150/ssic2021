    ...
    <section class="banner-conference">
        ...
        <div class="auto-container">
            <div class="content-box">
                ...
                <figure class="image-box" style="margin-bottom: 30px;"><img src="images/springerhome.png" style="width:150px;" alt=""><a style="margin-top:10px;">&nbsp;&nbsp;&nbsp;</a></figure>
                    ...
                    <div class="auto-container">
                        ...
                        <div class="row">
                            ...
                            <div class="gallery-item  col-md-6 col-sm-12 wow fadeIn">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/logo-clg.jpg" style="height: 80px;width: 250px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/uos.png" style="height: 80px;width: 250px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/deakin.png" style="height: 100px;width: 150px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/uni.jpeg" style="height: 100px;width: 150px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/panuni.jpeg" style="height: 100px;width: 150px;" alt=""></figure>
                                </div>
                            </div>
                            <!-- Gallery Item -->
                ...
                <section class="gallery-section" style="padding-top: 10px;padding-bottom: 10px;">
                    <div class="auto-container">
                        ...
                        <div class="row">
                            ...
                            <div class="gallery-item  col-md-6 col-sm-12 wow fadeIn">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/springer.png" style="height: 80px;width: 150px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/logo4.png" style="height: 100px;width: 200px;" alt=""></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><a href="https://www.springer.com/series/8767" target="__blank"><img src="images/speakers/book1.jpg" style="height: 150px;width: 150px;" alt=""></a></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><a href="https://www.springer.com/series/15179" target="__blank"><img src="images/speakers/book2.jpg" style="height: 150px;width: 150px;" alt=""></a></figure>
                                </div>
                            </div>
                            <div class="gallery-item col-md-6 col-sm-12 wow fadeIn" data-wow-delay="400ms">
                                <div class="image-box">
                                    <figure class="image"><img src="images/speakers/logo5.jpg" style="height: 150px;width: 200px;" alt=""></figure>
                                </div>
                            </div>
                            <!-- Gallery Item -->
                        ...
                        <div class="row">
                            ...
                            <div class="gallery-item offset-md-4 col-md-4 col-sm-12 wow fadeIn" id="eff" data-wow-delay="800ms">
                                <div class="image-box eyy" style="width:250px;">
                                    <figure class="image" ><img src="images/eff.png" style="height: 150px;width: 250px;" alt=""></figure>
                                </div>
                            </div>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="inner-box">
                        <div class="icon-box"><img class="icon" src="images/icons/manipal.png" style="height:60px;width:auto;"></img></div>
                ...
                <div class="feature-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                    <div class="inner-box">
                        <div class="icon-box"><img class="icon" src="images/icons/temple.png" style="height:60px;width:auto;"></img></div>
            ...
            <div class="row">
                ...
                <div class="speaker-block-three col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="heightfix inner-box">
                        <div class="image-box">
                            <figure class="image"><a target="_blank" href="http://class.ece.iastate.edu/arun/"><img src="images/speakers/dr.jpg" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="heightfix inner-box">
                        <div class="image-box">
                            <figure class="image"><a target="_blank" href="https://www.linkedin.com/in/subhajitbhattacharya07/"><img src="/images/speakers/subh.jpeg" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="heightfix inner-box">
                        <div class="image-box">
                            <figure class="image"><a target="_blank" href="https://www.linkedin.com/in/dr-priyadarsi-nanda-97489013/"><img src="images/speakers/Priyadarsi-Nanda.jpg" alt=""></a></figure>
                        </div>
                        <div class="info-box">

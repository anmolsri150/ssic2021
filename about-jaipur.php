            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title">About Jaipur</span>
                            <h2>Welcome to the PINK CITY</h2>
                            <div class="text">The name “Jaipur” literally means “City (Pur) of Victory (Jai)”. This is in relation to Jai Singh’s (1699-1744) victory over Aurangzeb’s planned attack against Vrindavana to destroy temples and deities. Jai Singh had heard of the planned attack and quickly went to Vrindavana to warn the people and save as many temples as possible. </div>
                        </div>
                        <div class="btn-box"><a href="https://en.wikipedia.org/wiki/Jaipur" class="theme-btn btn-style-two"><span class="btn-title">More About Jaipur</span></a></div>
                    </div>
                </div>
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash;End Event Info Section &ndash;&gt;-->

<!--    &lt;!&ndash; App Section &ndash;&gt;-->
<!--    <section class="app-section">-->
<!--        <div class="auto-container">-->
<!--            <div class="row">-->
<!--                &lt;!&ndash; Content Box &ndash;&gt;-->

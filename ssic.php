                    ...
                    <table cellpadding="0" cellspacing="0" class="t1">
                        ...
                        <tr>
                            ...
                            <td class="td8" valign="top">
                                <p class="p11"><span class="s1">&ldquo;Granular Mining and Rough-fuzzy Computing: Data to knowledge and Big data issues&rdquo;</span></p>
                        ...
                        <tr>
                            ...
                            <td class="td16" valign="top">
                                <p class="p11"><span class="s1">&ldquo;Innovation in Data Science/Engineering </span></p>

                                <p class="p11"><span class="s1">Analytics Fuels Growth of a Nation&rdquo;</span></p>
                            </td>
                        </tr>
                        <tr>
                            <td class="td13" valign="top">
                            ...
                            <td class="td16" valign="top">
                                <p class="p11"><span class="s1">&ldquo;Probabilistic Models and Game Theory Strategies for Wireless Sensor Networks &ldquo;</span></p>
                        ...
                        <tr>
                            ...
                            <td class="td16" valign="top">
                                <p class="p11"><span class="s1">&ldquo;Termite Spatial Correlation based Particle Swarm Optimization Algorithm &ldquo;</span></p>
